...
:menu
cls
echo Jika Anda Butuh Bantuan, Mohon Ketik "bantuan".
echo Jika Ingin Kembali Ke Semula atau Default, Mohon Ketik "revert".
echo Masukan Jumlah RAM Yang Anda Miliki! (Dalam Bentuk MB):
set /p a=
if "%a%" == "2048" goto :2048
if "%a%" == "3072" goto :3072
if "%a%" == "4096" goto :4096
...
if "%a%" == "131072" goto :131072
if "%a%" == "revert" goto :default
if "%a%" == "bantuan" goto :assist
cls
...
:131072
cls
reg add "HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Control" /v SvcHostSplitThresholdInKB /t REG_DWORD /d 134217728 /f > nul
reg add "HKLM\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management" /v "LargeSystemCache" /t REG_DWORD /d "1" /f > nul
PowerShell -Command "Disable-MMAgent -MemoryCompression"
cls
echo Value set to 131072MB (or 134217728)
timeout 2 > nul
cls
echo Exiting.
timeout 1 > nul
...
:assist
cls
echo Jika Anda Memakai 2GB RAM, Ketik 2048
echo Jika Anda Memakai 3GB RAM, Ketik 3072
echo Jika Anda Memakai 4GB RAM, Ketik 4096
echo Jika Anda Memakai 6GB RAM, Ketik 6144
echo Jika Anda Memakai 8GB RAM, Ketik 8192
echo Jika Anda Memakai 10GB RAM, Ketik 10240
echo Jika Anda Memakai 12GB RAM, Ketik 12288
echo Jika Anda Memakai 16GB RAM, Ketik 16384
echo Jika Anda Memakai 20GB RAM, Ketik 20480
echo Jika Anda Memakai 24GB RAM, Ketik 24576
echo Jika Anda Memakai 32GB RAM, Ketik 32768
echo Jika Anda Memakai 48GB RAM, Ketik 49152
echo Jika Anda Memakai 64GB RAM, Ketik 65536
echo Jika Anda Memakai 128GB RAM, Ketik 131072
echo.
echo Mau Kembali Ke Menu Awal?
set /p a=
if "%a%" == "iya" goto :menu
if "%a%" == "tidak" exit
